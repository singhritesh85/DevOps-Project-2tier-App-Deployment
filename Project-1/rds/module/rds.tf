...
resource "aws_db_subnet_group" "dbsubnet" {
  ...
  subnet_ids = ["subnet-7cXXXXX07", "subnet-c9XXXXXX84", "subnet-adXXXXXXc5"]  ##You should change this value as per your vpc subnet
}
...
resource "aws_db_instance" "dbinstance" {
  ...
  parameter_group_name = var.parameter_group_name[0]           ### var.parameter_group_name[1] use for postgresql
...
#  auto_minor_version_upgrade = true ## true or false
  ...
  enabled_cloudwatch_logs_exports = ["audit", "error", "general", "slowquery"]      ### ["postgresql", "upgrade"]  Use for PostgreSQL
